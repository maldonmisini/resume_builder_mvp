...
function saveCurrentProject() {
    ...
    if (projectName === '' || projectName === 'John Doe' || projectName === 'Name Surname') {
    ...
    if (selectedProjectIndex !== -1) {
        projects[selectedProjectIndex] = newProject;
    } else {
